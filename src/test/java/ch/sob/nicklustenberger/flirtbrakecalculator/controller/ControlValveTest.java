...
class ControlValveTest {
    ...
    void getControlPressure() {
        ...
        assertEquals(3.8f, controlValve.getControlPressure(2.0f), 0.001);
        assertEquals(3.8f, controlValve.getControlPressure(1.0f), 0.001);
        assertEquals(3.8f, controlValve.getControlPressure(0.0f), 0.001);
    }
}